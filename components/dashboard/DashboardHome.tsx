    ...
    <div>
      ...
      {showWelcome && (
        ...
        >
          <div>
            ...
            >
              <AnimatedNumber value={kpis.needs_attention} /> of your {kpis.total_providers}{' '}
              providers need attention. Click any provider below to review issues, approve
              corrections, and track resolution — everything updates automatically.
            </div>
          </div>
          <button
      ...
      <div style={{ display: 'flex', gap: spacing.md, marginBottom: spacing.xl }}>
        <div
          ...
          tabIndex={0}
          onKeyDown={(e) => {
            if (e.key === 'Enter' || e.key === ' ') navigateTo('/roster');
          }}
          style={{
            flex: 1,
        ...
        >
          <div style={{ ...typography.h1, color: colors.red }}>
            <AnimatedNumber value={kpis.needs_attention} />
          </div>
          <div style={{ ...typography.label, color: colors.red, marginTop: spacing.xs }}>
            Needs attention
          </div>
        </div>
        <div
        ...
        >
          <div style={{ ...typography.h1, color: '#96700A' }}>
            <AnimatedNumber value={kpis.in_progress} />
          </div>
          <div style={{ ...typography.label, color: '#96700A', marginTop: spacing.xs }}>
            In progress
          </div>
        </div>
        <div
        ...
        >
          <div style={{ ...typography.h1, color: colors.blue }}>
            <AnimatedNumber value={kpis.monitoring} />
          </div>
          <div style={{ ...typography.label, color: colors.blue, marginTop: spacing.xs }}>
            Monitoring
          </div>
        </div>
        <div
          ...
          style={{
            ...
            borderRadius: radii.lg,
            cursor: 'pointer',
            background: 'rgba(26,158,109,0.12)',
            transition: `all ${transitions.base}`,
            boxShadow: shadows.xs,
          }}
          onMouseOver={(e) => {
        ...
        >
          <div style={{ ...typography.h1, color: colors.green }}>
            <AnimatedNumber value={kpis.all_clear} />
          </div>
          <div style={{ ...typography.label, color: colors.green, marginTop: spacing.xs }}>
            All clear
          </div>
        </div>
      </div>
          ...
          {priorityProviders.length > 0 && (
            <StaggeredList>
              {priorityProviders.map((p) => {
                const issueColor =
                  p.open_issues >= 3 ? colors.red : p.open_issues >= 1 ? colors.red : colors.gold;
                const borderColor =
                  p.open_issues >= 3 ? colors.red : p.open_issues >= 1 ? colors.red : colors.gold;
                ...
                return (
                  <div
                    ...
                    tabIndex={0}
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' || e.key === ' ') setSelectedNpi(p.npi);
                    }}
                    style={{
                      background: '#fff',
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {getInitials(titleCase(p.provider_name))}
                      </div>
                      <div style={{ flex: 1 }}>
                        <div style={{ ...typography.h4, color: colors.navy }}>
                          {titleCase(p.provider_name)}
                        </div>
                      ...
                      >
                        {p.open_issues} issue{p.open_issues !== 1 ? 's' : ''}
                      </span>
                    </div>
                    <div
                      style={{
        ...
        <div>
          ...
          <div style={{ marginBottom: spacing.md }}>
            ...
            >
              ...
              <div
                style={{ ...typography.bodySmall, color: colors.gray400, marginTop: spacing.xs }}
              >
                Compliance score
              </div>
              <div
          ...
          <div>
            ...
            >
              {payers.map((p, i) => (
                ...
                >
                  <div
                    style={{ width: 6, height: 6, borderRadius: radii.full, background: p.color }}
                  />
