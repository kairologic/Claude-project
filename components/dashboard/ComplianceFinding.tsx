...
const STATUTE_INFO: Record<string, {
  name: string;
  state: string;
  summary: string;
  requirement: string;
  ...
  'SB 1188': {
    ...
    state: 'Texas',
    summary: 'Requires accurate provider directory information for health plans operating in Texas.',
    requirement: 'Provider directories must be updated within 5 business days of receiving notice of a change.',
  ...
  'AB 3030': {
    ...
    state: 'California',
    summary: 'California provider directory accuracy law requiring health plans to maintain accurate online directories.',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12, fontWeight: 600, color: colors.navy, textTransform: 'capitalize' }}>
              {fieldName}
            </div>
          </div>
          <div style={{
            ...
            <div style={{ fontSize: 12, fontWeight: 600, color: colors.navy, wordBreak: 'break-word' }}>
      ...
      {(isTemplate || expandedTemplate) && (
        <div style={{
          ...
          <div style={{
            ...
            <strong>1.</strong> Verify the correct {fieldName} for this provider<br />
            <strong>2.</strong> Update the practice website to reflect the correct value<br />
            <strong>3.</strong> If NPPES is also incorrect, submit an NPPES correction (a linked workflow will be created)<br />
            <strong>4.</strong> Update CAQH ProView if the discrepancy affects payer directories<br />
            <strong>5.</strong> Document the correction date for compliance audit trail<br />
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        {isShowFinding && activeTask && (
          ...
          >
            {actioningTask === activeTask.id ? 'Updating...' : 'Acknowledged — show remediation steps'}
          </button>
        )}
        ...
        {isTemplate && activeTask && (
          ...
          >
            {actioningTask === activeTask.id ? 'Updating...' : 'Remediation applied — request rescan'}
          </button>
        )}
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: colors.gray600 }}>
                KairoLogic is rescanning your practice website to confirm the compliance issue has been resolved.
