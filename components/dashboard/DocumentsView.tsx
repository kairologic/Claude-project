      ...
      {documents.length > 0 ? (
        ...
        >
          ...
          <div
            style={{
              display: 'grid',
              gridTemplateColumns: '2.5fr 0.7fr 0.7fr 1.2fr 0.8fr',
              padding: '10px 16px',
        ...
        >
          ...
          >
            Documents are generated automatically when you approve corrections. Pre-filled NPPES
            forms, correction packets, and checklists will appear here.
          </div>
        </div>
      )}
    </div>
