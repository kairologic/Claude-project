...
export default function FeedbackModal({
  ...
  const handleSubmit = async () => {
    ...
    if (!description.trim()) { setError('Please describe the ' + (isIssue ? 'issue' : 'feature')); return; }
        ...
        <div style={s.body}>
          ...
          <div style={s.fieldGroup}>
            ...
            <input
              style={s.input}
              type="text"
              placeholder={isIssue ? 'Brief description of the issue' : 'What feature would you like?'}
              value={subject}
