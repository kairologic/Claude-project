...
function getCellStatus(
  ...
  // Include both provider-specific AND practice-level (npi='PRACTICE') mismatches
  const matchesNpi = (m: MismatchData) => m.npi === npi || m.npi === 'PRACTICE';

  // Check for not_listed or acceptance_gap (practice-level payer issues)
  ...
  // If no snapshot and no mismatch, no data
