  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.kpiRow}>
        <div
          style={{ ...styles.kpiBox, background: colors.redPale, borderColor: `${colors.red}33` }}
        >
          <div style={{ ...styles.kpiNum, color: colors.red }}>{findings.total}</div>
          <div style={styles.kpiLabel}>Data discrepancies found</div>
        </div>
        <div
          style={{ ...styles.kpiBox, background: colors.goldPale, borderColor: `${colors.gold}33` }}
        >
        ...
        <div
          style={{ ...styles.kpiBox, background: colors.bluePale, borderColor: `${colors.blue}33` }}
        >
        ...
        <div style={styles.findingsList}>
          {findings.address_mismatches > 0 && (
            <FindingRow
              ...
              count={findings.address_mismatches}
          ...
          {findings.phone_mismatches > 0 && (
            <FindingRow
              icon="📞"
              label="Phone mismatches"
              count={findings.phone_mismatches}
          ...
          {findings.name_mismatches > 0 && (
            <FindingRow
              ...
              count={findings.name_mismatches}
          ...
          {findings.taxonomy_mismatches > 0 && (
            <FindingRow
              icon="🏥"
              label="Specialty mismatches"
              count={findings.taxonomy_mismatches}
      ...
      <div style={styles.section}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {providers.slice(0, 3).map((p, i) => {
            const initials = p.provider_name
              .split(' ')
              .filter(Boolean)
              .map((n) => n[0])
              .join('')
          ...
          {totalProviders > 3 && (
            <div style={styles.moreProviders}>
              + {totalProviders - 3} more provider{totalProviders - 3 !== 1 ? 's' : ''} with
              findings
            </div>
          )}
        </div>
          ...
          <div style={styles.dashMock}>
            ...
            <div style={styles.mockSidebar}>
              ...
              >
                ...
                <div style={{ fontSize: 8, color: colors.navyLight }}>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: '6px 12px',
                    fontSize: 11,
                    color: item.active ? '#fff' : colors.navyLight,
                    fontWeight: item.active ? 700 : 500,
                    background: item.active ? colors.navyMid : 'transparent',
                    position: 'relative',
                  }}
                >
              ...
              {['🔐 Credentialing', '📊 Reports', '⚙️ Settings'].map((item, i) => (
                <div
                  key={i}
                  style={{ padding: '5px 12px', fontSize: 11, color: 'rgba(139,163,184,.3)' }}
                >
                  {item}
                </div>
              ))}
            ...
            <div style={styles.mockMain}>
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: 9, color: colors.gray400 }}>
                    {practice.name} · {practice.provider_count} providers
                  </div>
                </div>
              ...
              <div style={{ padding: '12px 16px 8px', display: 'flex', gap: 8 }}>
                ...
                >
                  <div style={{ fontSize: 18, fontWeight: 800, color: colors.red }}>
                    {findings.total}
                  </div>
                  <div
                    style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {providers.slice(0, 3).map((p, i) => (
                    ...
                    >
                      ...
                      <div style={{ fontSize: 10, fontWeight: 700, color: colors.navy }}>
                        {p.provider_name} — Address mismatch
                      </div>
                      <div style={{ fontSize: 8, color: colors.gray600, marginTop: 2 }}>
                        NPPES data differs from website listing
                      </div>
                      <div
                        style={{
                          height: 3,
                  ...
                  {providers.slice(0, 3).map((p, i) => (
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <span style={{ fontSize: 10, fontWeight: 700, color: colors.navy }}>
                          {p.provider_name}: Mismatch detected
                        </span>
                        <span
                          style={{
                            fontSize: 6,
                      ...
                      <div style={{ fontSize: 8, color: colors.gray600, paddingLeft: 9 }}>
          ...
          <div style={styles.dashOverlay}>
            <div style={styles.dashOverlayContent}>
              ...
              <div style={styles.dashOverlayDesc}>
                Workflow tracking, pre-filled NPPES forms, payer directory monitoring, license
                alerts, and automatic confirmation
              </div>
              <div
                style={{
                  display: 'flex',
        ...
        {!submitted ? (
          <>
            ...
            <div style={styles.claimDesc}>
              Enter your email to access your full Practice Intelligence Dashboard with actionable
              workflows, pre-filled correction forms, and automatic monitoring.
            </div>
            ...
            <div style={styles.claimSub}>Free trial · No credit card · HIPAA-aligned</div>
          </>
        ) : (
          <div style={styles.claimSuccess}>
            ...
            <div style={styles.successDesc}>
              We sent a verification link to <strong>{email}</strong>. Click the link to set your
              password and access your dashboard for {practiceName || practice.name}.
            </div>
      ...
      <div style={styles.footer}>
        ...
        <div style={styles.footerText}>
          Provider data intelligence for independent medical practices. Data sourced from NPPES, CMS
          PECOS, state medical boards, and payer FHIR directories.
        </div>
      </div>
    </div>
  );
