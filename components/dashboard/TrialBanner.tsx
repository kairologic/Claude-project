        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-emerald-400 text-sm font-bold">
              Premium trial active \u2014 {trialState.days_remaining} day
              {trialState.days_remaining !== 1 ? 's' : ''} remaining
            </p>
            <p className="text-slate-400 text-xs mt-1">
              Full Protect-tier access. Forms, alerts, roster surveillance, and auto-confirmation
              included.
            </p>
          </div>
          <a
            href={upgradeUrl}
            className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-bold px-4 py-2 rounded-lg text-xs hover:bg-emerald-500/20 transition-colors whitespace-nowrap"
          >
            Keep access \u2014 $99/mo
          </a>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-amber-400 text-sm font-bold">
              Premium access expires in {trialState.days_remaining} day
              {trialState.days_remaining !== 1 ? 's' : ''}
            </p>
            <p className="text-slate-400 text-xs mt-1">
          ...
          <a
            href={upgradeUrl}
            className="bg-gold text-navy font-bold px-5 py-2 rounded-lg text-sm hover:bg-gold-dark transition-colors whitespace-nowrap"
          >
            Upgrade now \u2014 $99/mo
          </a>
        </div>
...
export function UpgradePrompt({ feature, requiredTier, practiceId, onClose }: UpgradePromptProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div
        className="relative bg-navy-light border border-white/[0.08] rounded-2xl p-8 max-w-md w-full"
      ...
      >
        ...
        <h3 className="text-white font-bold text-lg text-center mb-2">Unlock {feature}</h3>
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-5 mb-6">
          ...
          <p className="text-gold text-xs font-bold text-center">
            Founder's Rate \u2014 locked for 12 months
          </p>
