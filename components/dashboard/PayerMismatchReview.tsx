    ...
    <div style={{
              ...
              {sources.map((source, idx) => {
                ...
                return (
                  <tr
                    key={idx}
                    style={{
                      borderBottom: idx < sources.length - 1 ? `1px solid ${colors.gray200}` : 'none',
                    }}
                  >
                    <td style={{
                      padding: 10,
                    ...
                    <td style={{
                      padding: 10,
                      color: colors.navy,
                      background: idx === 0 ? colors.bluePale : (matches ? colors.greenPale : colors.redPale),
      ...
      <div style={{
        ...
        <div style={{
          ...
          Most payers (UHC, Aetna, Humana) pull provider data from CAQH automatically.
          Updating your CAQH profile is the fastest path to correcting multiple payer directories at once.
        </div>
        ...
        {showCaqhGuide && (
          <div style={{
            ...
            <strong>Steps to update CAQH:</strong><br />
            1. Log in to <strong>proview.caqh.org</strong><br />
            2. Navigate to Practice Location section<br />
            3. Update the <strong>{fieldName}</strong> field to match the correct value<br />
            4. Click Re-attest to submit changes<br />
