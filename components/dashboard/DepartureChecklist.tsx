      ...
      {isMonitoring && (
        ...
        >
          ...
          <div>
            ...
            >
              KairoLogic is monitoring payer directories for 90 days to ensure{' '}
              {providerName || 'this provider'} no longer appears. Phantom listings can cause
              misdirected patients and compliance issues.
            </div>
          </div>
        </div>
      )}
