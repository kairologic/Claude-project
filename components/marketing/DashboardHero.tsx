        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 9, color: '#94a3b8', fontFamily: "'Courier New',monospace" }}>
                {npi}
              </div>
            </div>
          </div>
          ...
          {tags.map((t, i) => (
            <span
              ...
              style={{
                ...
                borderRadius: 3,
                background:
                  t === 'Credentialing' ? '#eff6ff' : t === 'Address' ? '#fef2f2' : '#fff7ed',
...
function AccRow({
  ...
  const cellStyle = (_val: string, isMismatch: boolean): React.CSSProperties => ({
    fontSize: 9.5,
    padding: '6px 4px',
    color: isMismatch ? '#dc2626' : '#475569',
...
function DashboardHeroInner() {
  ...
  useEffect(() => {
    setMounted(true);
    // Simulate click on Robert Connaughton row
    const t1 = setTimeout(() => setClickPulse(true), 1400);
    const t2 = setTimeout(() => setShowPanel(true), 1700);
    return () => {
      clearTimeout(t1);
      clearTimeout(t2);
    };
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* ═══ MAIN CONTENT ═══ */}
            <div
              style={{ flex: 1, padding: '16px 20px', overflow: 'hidden', position: 'relative' }}
            >
              {/* Header row */}
              <Fade delay={200}>
                <div
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 9.5, color: '#94a3b8' }}>
                      NORTH TEXAS MEDICAL SURGICAL CLINIC PA · 18 providers · Last sync: 2 hours ago
                    </div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <div
                    ...
                    <div
                      style={{ fontSize: 9, color: '#64748b', textAlign: 'right', lineHeight: 1.3 }}
                    >
                      Monday, March 23,
                      <br />
                      2026
              ...
              <Fade delay={350}>
                ...
                >
                  ...
                  <div style={{ fontSize: 10.5, color: '#64748b', lineHeight: 1.5 }}>
                    17 of your 19 providers need attention. Click any provider below to review
                    issues, approve corrections, and track resolution.
                  </div>
                  <div
                    style={{
                      position: 'absolute',
              ...
              >
                ...
                <Fade delay={1850}>
                  <div
                    style={{
                      display: 'grid',
                      gridTemplateColumns: '62px 1fr 1fr 50px 50px 60px',
                      gap: 2,
                      marginBottom: 2,
                    }}
                  >
                ...
                <AccRow
                  field="Address"
                  nppes="1105 Central Exp..."
                  uhc="1105 Central Exp..."
                  aetna="—"
                  cigna="800 8th Ave #306"
                  humana="85 Maui L..."
                  delay={1890}
                  mismatch
                />
