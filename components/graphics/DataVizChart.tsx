...
export default function DataVizChart({
  ...
  const chartData = data.map((d) => {
    const name = String(
      d[nameKey] || d.status || d.state || d.category || d.method || d.week || '',
    );
        ...
        {chartType === 'bar' && (
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData} margin={{ top: 10, right: 20, left: 0, bottom: 10 }}>
              ...
              <XAxis
                dataKey="name"
                tick={{ fill: BRAND.gray400, fontSize: 12 }}
        ...
        {chartType === 'donut' && (
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              ...
              />
              <Legend wrapperStyle={{ color: BRAND.gray400, fontSize: 12 }} />
            </PieChart>
          </ResponsiveContainer>
        )}
