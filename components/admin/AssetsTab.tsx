    ...
    assets: [
      {
        ...
        type: 'pdf',
        description:
          '12 policy sections + 3 appendices. Covers data residency, vendor due diligence, AI transparency, employee obligations, incident response, and audit procedures.',
      ...
      },
      {
        ...
        type: 'pdf',
        description:
          '6-phase step-by-step implementation workflow with checklists. Covers policy customization, AI disclosure deployment, vendor hardening, staff training, and registry verification.',
        version: 'v1.0 — Feb 2026',
        pages: '15+ pages',
      ...
      },
      {
        ...
        type: 'pdf',
        description:
          '8 copy-ready assets: website footer notice, patient consent form, privacy policy section, phone scripts, staff guidelines, social media template, waiting room signage, vendor verification email.',
        version: 'v1.0 — Feb 2026',
        pages: '12+ pages',
      ...
      },
      {
        ...
        type: 'pdf',
        description:
          '7 training modules: data sovereignty rules, prohibited tools, AI transparency, vendor checks, leak reporting, real-world scenarios, quick reference card. Includes staff attestation form.',
        version: 'v1.0 — Feb 2026',
        pages: '15+ pages',
      ...
      },
      {
        ...
        type: 'pdf',
        description:
          '4-phase roadmap from Pre-Audited to Verified Sovereign. Full checklists with owner, deliverable, and checkbox columns. Includes ongoing quarterly maintenance schedule.',
        version: 'v1.0 — Feb 2026',
        pages: '10+ pages',
      ...
      },
      {
        ...
        type: 'xlsx',
        description:
          '5-tab workbook: Digital Supply Chain Inventory, Technical Residency Signals, Regulatory & Cure Notice Log, Quarterly Audit Trail, Instructions & Reference. Pre-formatted with data validations and formulas.',
        version: 'v1.0 — Feb 2026',
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            ...
            <div className="text-sm font-bold text-navy">
              {existingAssets} / {totalAssets} generated
            </div>
          </div>
          <button
        ...
        return (
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 bg-gradient-to-br ${folder.color} rounded-xl flex items-center justify-center text-white`}
                >
                  {folder.icon}
                </div>
              ...
              <div className="border-t border-slate-100">
                          ...
                          <div className="flex items-center gap-3 mt-2 text-[10px] text-slate-400">
                            ...
                            {status?.exists && (
                              <>
                                ...
                                {status.modified && (
                                  <span>
                                    • Last generated: {new Date(status.modified).toLocaleString()}
                                  </span>
                                )}
                              </>
                            )}
                ...
                <div className="px-4 py-3 bg-gradient-to-r from-navy/5 to-transparent border-t border-slate-100">
                  <div className="flex items-center gap-2 text-[10px] text-slate-400">
                    ...
                    <span>
                      Files stored in{' '}
                      <code className="bg-slate-100 px-1 py-0.5 rounded text-[9px] font-mono">
                        /public/assets/safe-harbor/
                      </code>
                    </span>
                    <span>•</span>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">
              Each document is generated server-side using branded Python templates with the
              KairoLogic navy/gold design system. Click <strong>Regenerate</strong> to rebuild
              individual files, or <strong>Update &amp; Regenerate All</strong> to rebuild the
              entire bundle. Generated files are served from{' '}
              <code className="bg-white px-1 py-0.5 rounded text-[9px] font-mono">
                /assets/safe-harbor/
              </code>{' '}
              and can be linked in Stripe post-purchase delivery emails. Generator scripts are in{' '}
              <code className="bg-white px-1 py-0.5 rounded text-[9px] font-mono">
                /scripts/safe-harbor/
              </code>
              .
