...
const STRIPE_PK =
  'pk_live_51SqnMvGg3oiiGF7gMSDPwdLYbU7pLsS5cqc8QGZuZQIIAqWz2xD5NwFBVFLrOiQGyHBV4UeNqwq9f5WgyuGXARsw001mJX03so';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-orange/10 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-orange font-bold text-sm uppercase tracking-wider">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Your practice scored <strong className="text-orange">{score}/100</strong>. Statutory
              penalties for knowing violations can reach $250,000. Get your full remediation roadmap
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <div className="bg-navy rounded-2xl p-8 text-left shadow-lg">
              <div className="text-3xl mb-3">&#x1F4C5;</div>
              <h3 className="text-xl font-display font-bold text-white mb-2">Request Briefing</h3>
              <p className="text-gray-300 text-sm mb-3">
                15-minute session with our engineering desk to walk through your OCONUS drift points
    ...
    <section className="py-16 bg-navy">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto">
          Your practice scored <strong className="text-green-400">{score}/100</strong>. Close
          remaining gaps with targeted remediation to achieve full Sovereign status.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 text-left shadow-xl">
            ...
            <p className="text-gray-600 text-sm mb-6">
              Targeted remediation scripts, Safe Harbor checklist, and disclosure templates to close
              your remaining gaps.
            </p>
          ...
          <div className="bg-white/5 border-2 border-white/20 rounded-2xl p-8 text-left">
            ...
            <p className="text-gray-300 text-sm mb-6">
              Lock in your compliance with continuous monitoring, automated pulse scans, and the
              KairoLogic Trust Seal.
            </p>
