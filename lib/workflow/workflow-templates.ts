...
export const ONBOARDING_TASKS: TaskTemplate[] = [
  ...
  },
  {
    ...
    description:
      'Enroll the provider in CAQH ProView with current credentials and practice address',
    group: 'submit_wait',
  },
  {
    task_order: 4,
  ...
  },
  {
    ...
    description:
      'Auto-checks payer directories weekly until provider appears in all contracted payers',
    group: 'monitoring',
  },
];
...
export const LICENSE_RENEWAL_TASKS: TaskTemplate[] = [
  {
    ...
    description:
      'Confirm which state license is expiring and verify current license number and status with the state board',
    group: 'immediate',
  },
  {
    task_order: 2,
    ...
    description:
      'Complete and submit the renewal application with the state medical board, including any required CE documentation',
    group: 'submit_wait',
  },
  {
    task_order: 3,
    ...
    description:
      'Once renewed, update CAQH ProView profile and notify contracted payers of new license number and expiration date',
    group: 'submit_wait',
  },
  {
    task_order: 4,
    ...
    description:
      'Auto-checks weekly until the state board shows the license as active with the new expiration date',
    group: 'monitoring',
  },
];
