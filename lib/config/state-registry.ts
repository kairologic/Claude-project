  ...
  complianceStatutes: [
    {
      ...
      mismatchThreshold: 3,
      description:
        'Texas Senate Bill 1188 — requires accurate provider data across state-regulated directories',
    },
    {
      code: 'HB 149',
      ...
      mismatchThreshold: 3,
      description:
        'Texas House Bill 149 — transparency requirements for AI-driven provider data systems',
    },
  ],
  statePayers: [{ payerCode: 'bcbstx', payerName: 'BCBS TX', stateSpecific: true }],
...
const CALIFORNIA: StateConfig = {
  ...
  statePayers: [{ payerCode: 'blueshieldca', payerName: 'Blue Shield CA', stateSpecific: true }],
 ...
 */
export function calculateComplianceScore(stateCode: string, mismatchCount: number): number {
 ...
 */
export function normalizeLicenseStatus(stateCode: string, rawStatus: string): LicenseStatus {
