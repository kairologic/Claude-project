...
export const typography = {
  ...
  /** Uppercase labels */
  label: { fontSize: 10, fontWeight: 700 as const, lineHeight: 1.4, letterSpacing: '0.04em', textTransform: 'uppercase' as const },
  /** Monospace for NPI, IDs, codes */
  mono: { fontSize: 12, fontWeight: 500 as const, fontFamily: "'SF Mono', 'Fira Code', 'Cascadia Code', Consolas, monospace" },
} as const;
