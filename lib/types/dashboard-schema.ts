...
export const WORKFLOW_TYPE_DISPLAY: Record<
  WorkflowType,
  {
    label: string;
    tooltip: string;
...
> = {
  ...
  onboarding: {
    label: 'ONBOARDING',
    tooltip: 'New provider credentialing workflow — CAQH, payer enrollment, NPPES, website updates',
  },
  release: {
    label: 'RELEASE',
    tooltip: 'Provider departure workflow — website removal, NPPES update, payer notifications',
  },
  license_renewal: {
