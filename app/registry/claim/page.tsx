              ...
              {(() => {
                ...
                return (
                  <div className="space-y-3">
                    <a href={`https://buy.stripe.com/test_dRm4gz9aX7ty9oz6VK4ko02${clientRef}`} target="_blank" rel="noopener noreferrer"
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-slate-400 text-xs">Detailed forensic analysis with legal evidence mapping</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                    ...
                    <a href={`https://buy.stripe.com/test_8x2bJ14UHbJO30b93S4ko03${clientRef}`} target="_blank" rel="noopener noreferrer"
