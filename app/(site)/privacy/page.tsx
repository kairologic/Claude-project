    ...
    <div>
      <section className="bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl font-display font-bold text-navy mb-4">Privacy Policy</h1>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg">
          ...
          <p>
            KairoLogic collects information necessary to provide compliance scanning and advisory
            services:
          </p>
          <ul>
          ...
          <p>
            In compliance with Texas SB 1188, all data is stored on servers physically located
            within the United States. We implement industry-standard security measures including
