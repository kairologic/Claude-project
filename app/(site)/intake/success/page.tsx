        ...
        <div className="p-8 md:p-12">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-lg mx-auto leading-relaxed">
              Thank you. Our Sentry Engine has completed the preliminary scan of your digital
              border. A summary has been dispatched to your email.
            </p>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start text-sm">
                  ...
                  <p>
                    <span className="font-semibold">Review your Inbox:</span> Your Executive Risk
                    Summary should arrive in 2-3 minutes.
                  </p>
                </li>
                <li className="flex items-start text-sm">
                  <span className="font-mono text-navy font-bold mr-3">02.</span>
                  <p>
                    <span className="font-semibold">Schedule Your Briefing:</span> Book a 15-minute
                    session with our compliance engineering desk.
                  </p>
                </li>
                <li className="flex items-start text-sm">
                  <span className="font-mono text-navy font-bold mr-3">03.</span>
                  <p>
                    <span className="font-semibold">Statutory Shield:</span> Finalize your
                    Remediation Roadmap to protect against the $250k penalty risk.
                  </p>
                </li>
              </ul>
            </div>
