      ...
      <section className="bg-navy text-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Complete your practice profile so our Sentry Engine can perform a comprehensive forensic
            analysis of your digital infrastructure.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center gap-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-orange text-white rounded-full flex items-center justify-center text-sm font-bold">
                1
              </div>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-sm mb-3">Already completed your intake?</p>
