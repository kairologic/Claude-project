    ...
    <div>
      <section className="bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl font-display font-bold text-navy mb-4">Why KairoLogic Exists</h1>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg">
          ...
          <p>
            ...
            sovereignty and AI transparency that go well beyond HIPAA. In fact, the The Texas
            Responsible AI Governance Act (TRAIGA) requires broad compliance. California followed
            with AB 3030, mandating disclosure when AI is used in clinical decision-making. More
            states are drafting their own versions. The pattern is clear: healthcare compliance is
            going local, fast, and the federal floor is no longer the ceiling.
          </p>
          <p>
            Most providers have no idea. We scanned hundreds of Texas healthcare websites and found
            that &gt;50% route patient data through foreign servers. Almost none of them disclose
            their use of AI tools. NPI records, the backbone of provider identity, are riddled with
            mismatches between what&apos;s on file and what&apos;s on the website. These aren&apos;t
            edge cases. They&apos;re the norm.
          </p>
          ...
          <p>
            ...
            Risk Mitigation Index, a breakdown by category, and a clear path to fix what&apos;s
            broken.
          </p>
          <p>
            For providers who need ongoing coverage, our Shield dashboard monitors compliance drift
            in real time, flagging new trackers, foreign data routing changes, roster mismatches,
            and other shifts that happen silently between point-in-time audits. As more states move
            toward 'Sovereign Data' models, KairoLogic is building the universal translation layer
            that allows a single dashboard to govern multi-state requirements simultaneously.
          </p>
          ...
          <p>
            ...
            the assumption is that the information stays accurate. In practice, providers move,
            change affiliations, update websites, and add locations without ever touching their NPI
            records. The result is a growing gap between what the NPI database says about a provider
          ...
          <p>
            ...
            track. A practice operating in Texas and California already faces two different
            compliance regimes, and they&apos;re not always compatible.
          </p>
          <p>
