        ...
        {!sent ? (
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-400 text-sm mt-2">
                Enter the email address associated with your KairoLogic account. We&apos;ll send you
                a secure login link.
              </p>
            </div>
                    ...
                    <div>
                      ...
                      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-3">
                        ...
                        <p className="text-slate-400 text-xs">
                          Contact us at{' '}
                          <a
                            href="mailto:support@kairologic.net"
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 text-center">
            ...
            <p className="text-slate-400 text-sm mb-4">
              We sent a login link to <strong className="text-white">{email}</strong>. Click the
              link to continue.
            </p>
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-lg p-4 text-xs text-slate-500 space-y-1.5">
              <p>
                <strong className="text-slate-400">Step 1:</strong> Click the login link in your
                email
              </p>
              <p>
                <strong className="text-slate-400">Step 2:</strong> Enter the 6-digit verification
                code we&apos;ll send separately
              </p>
              <p className="text-slate-600 pt-1">
                🔒 You can choose to trust your device so you won&apos;t need a code next time
              </p>
            </div>
