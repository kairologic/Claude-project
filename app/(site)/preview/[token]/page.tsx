...
export default async function PreviewServerPage({ params }: { params: { token: string } }) {
  ...
  if (tokenData.is_claimed) {
    return (
      <ExpiredPage
        message="This practice has already been claimed. Please log in to access your dashboard."
        showLogin
      />
    );
  }
  ...
  const { data: providers } = await admin
    ...
    .select(
      'provider_name, npi, active_mismatch_count, has_address_mismatch, has_phone_mismatch, has_taxonomy_mismatch, has_name_mismatch, has_license_issue',
    )
