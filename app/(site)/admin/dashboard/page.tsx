...
import { AlertCircle, TrendingUp, Users, Zap, CheckCircle, Activity, Clock } from 'lucide-react';
    ...
    >
      ...
      <div className="kpi-grid">
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-value">{isLoading ? '—' : kpiData.totalPractices}</div>
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-value">{isLoading ? '—' : kpiData.activeAlerts}</div>
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-value">{isLoading ? '—' : kpiData.openIssues}</div>
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-value">{isLoading ? '—' : kpiData.contentItems}</div>
        ...
        <div className="quick-actions">
          <Link href="/admin/practices" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="action-card">
              ...
              <div
                ...
                style={{ backgroundColor: '#E6F7F2', color: colors.green }}
              >
                <Users size={24} />
              </div>
            </div>
          ...
          <Link href="/admin/alerts" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="action-card">
              ...
              <div
                className="action-card-icon"
                style={{ backgroundColor: '#FDEEEE', color: colors.red }}
              >
                <AlertCircle size={24} />
              </div>
            </div>
          ...
          <Link href="/admin/issues" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="action-card">
              ...
              <div
                className="action-card-icon"
                style={{ backgroundColor: '#FDF6E3', color: colors.gold }}
              >
                <CheckCircle size={24} />
              </div>
            </div>
