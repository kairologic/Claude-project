        ...
        {filterOptions.map((option) => (
          <button
            ...
            style={{
              ...
              border: 'none',
              backgroundColor: selectedFilter === option.value ? colors.blue : colors.white,
              color: selectedFilter === option.value ? colors.white : colors.navy,
              cursor: 'pointer',
              ...typography.body,
