...
const PRODUCTS = [
  ...
  },
  {
    ...
    type: 'One-time',
    description:
      'Everything in Audit Report + policies, AI disclosures, training, blueprint + 3 months Shield FREE',
  ...
  },
  {
    ...
    type: 'Recurring',
    description:
      'Continuous compliance monitoring + free audit report + dashboard + quarterly reports',
      ...
      <div className="bg-navy text-white py-6 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-sm">
            Test payment links, webhook events, email triggers, and download flows
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <p className="text-xs text-gray-400 mt-2">
            These will be passed as client_reference_id and prefilled_email to Stripe
          </p>
        </div>
              ...
              <div key={product.id} className={`rounded-xl border-2 p-5 ${product.color}`}>
                ...
                {product.trialIncluded && (
                  <div className="text-xs font-bold text-green-600 mb-3">
                    ✦ Includes 3 months Shield trial
                  </div>
                )}
                <a
          ...
          <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-3">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-amber-600">
                — These are real payment links. Use a real card or Stripe test cards will NOT work
                in live mode.
              </span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-500 mb-3">
            After a payment completes, paste the session_id to verify what our API returns:
          </p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-500 mb-3">
            Send test emails to <strong>{testEmail}</strong>:
          </p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-500 mb-3">
            Preview the post-purchase success page for each product:
          </p>
          <div className="flex flex-wrap gap-2">
            {PRODUCTS.map((product) => (
              <a
              ...
              <tbody className="divide-y divide-gray-100">
                <tr>
                  ...
                  <td className="py-2 text-xs">
                    Create Shield subscription with trial_period_days=90
                  </td>
                </tr>
                <tr>
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="py-2 text-xs text-gray-400">
                    No Payment Link — post-trial downgrade option
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="space-y-2 text-sm">
            {[
              ...
              { key: 'STRIPE_WEBHOOK_SECRET', desc: 'whsec_... (live webhook signing secret)' },
              {
                ...
                desc: 'pk_live_... (live publishable key)',
              },
