...
function statusBadge(status: string): { bg: string; text: string; label: string } {
  switch (status) {
    case 'active':
      return { bg: '#dcfce7', text: green, label: 'Active' };
    case 'unclaimed':
      return { bg: '#fef3c7', text: '#92400e', label: 'Unclaimed' };
    case 'error':
      return { bg: '#fee2e2', text: red, label: 'Error' };
    default:
      return { bg: gray200, text: gray600, label: status };
  }
}
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: 24 }}>
          ...
          <div>
            ...
            >
              ...
              <a
                ...
                style={{ color: '#185FA5', fontSize: 13, textDecoration: 'none' }}
              >
                {p.url} ↗
              </a>
              ...
              {p.organization_id && (
                <span style={{ color: gray400, fontSize: 12 }}>
        ...
        {p.dashboard_issues.length > 0 && (
          <div
            style={{
              ...
              padding: 16,
              marginBottom: 20,
              border: `1px solid ${gray600}33`,
            }}
          >
            <h3 style={{ margin: '0 0 10px', fontSize: 14, color: gold, fontWeight: 600 }}>
              Dashboard Issues
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              {p.dashboard_issues.map((issue, i) => (
                ...
                >
                  ...
                  <span style={{ color: gray400, fontSize: 11, marginLeft: 'auto' }}>
                    {issue.type}
                  </span>
                </div>
              ))}
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                ...
                <span
                  style={{
                    background: scanBadge.bg,
                    color: scanBadge.text,
                    padding: '1px 8px',
                    borderRadius: 8,
                    fontSize: 12,
                    fontWeight: 600,
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                ...
                <span style={{ color: p.consecutive_errors > 0 ? red : 'inherit' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                ...
                <span style={{ color: p.providers_unverified > 0 ? gold : 'inherit' }}>
                  {p.providers_unverified}
                </span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                <span style={{ color: gray400 }}>Departed</span>
                <span style={{ color: p.providers_departed > 0 ? red : 'inherit' }}>
                  {p.providers_departed}
                </span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                ...
                <span
                  style={{ color: p.delta_events_unresolved > 0 ? red : green, fontWeight: 700 }}
                >
              ...
              {p.delta_events_total > 0 && (
                <div style={{ marginTop: 4 }}>
                  ...
                  <div style={{ fontSize: 11, color: gray400, marginTop: 4 }}>
                    {Math.round(
                      ((p.delta_events_total - p.delta_events_unresolved) / p.delta_events_total) *
                        100,
                    )}
                    % resolved
                  </div>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                ...
                <span style={{ color: p.payer_snapshots_not_listed > 0 ? red : 'inherit' }}>
                  {p.payer_snapshots_not_listed}
                </span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                <span style={{ color: gray400 }}>Open Mismatches</span>
                <span
                  style={{ color: p.payer_mismatches_open > 0 ? gold : green, fontWeight: 600 }}
                >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
                ...
                <span
                  style={{ color: p.workflows_action_needed > 0 ? red : green, fontWeight: 700 }}
                >
        ...
        <div
          style={{
            ...
            background: '#0d1925',
            borderRadius: 8,
            border: `1px solid ${gray600}22`,
            fontSize: 12,
            color: gray400,
          }}
        >
          <strong style={{ color: gray600 }}>Internal:</strong> Practice ID:{' '}
          <code style={{ color: '#93c5fd' }}>{p.id}</code>
          {p.organization_id && (
            <>
              {' '}
              · Org ID: <code style={{ color: '#93c5fd' }}>{p.organization_id}</code>
            </>
          )}
