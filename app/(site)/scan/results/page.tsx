...
function ConsultationCard({ variant }: { variant: 'light' | 'dark' }) {
  ...
  return (
    <div
      className={`${isDark ? 'bg-navy' : 'bg-white border-2 border-navy/10'} rounded-2xl p-7 text-left shadow-lg`}
    >
      <div
        className={`w-12 h-12 ${isDark ? 'bg-white/10' : 'bg-navy/5'} rounded-xl flex items-center justify-center mb-4`}
      >
      ...
      <p className={`${isDark ? 'text-gray-300' : 'text-gray-500'} text-sm mb-3 leading-relaxed`}>
        Walk through your compliance drift points and migration requirements with our engineering
        desk.
      </p>
      <div className={`${isDark ? 'bg-white/10' : 'bg-gold/10'} rounded-lg px-3 py-2 mb-5`}>
        <span
          className={`${isDark ? 'text-gold' : 'text-amber-700'} text-xs font-bold uppercase tracking-wider`}
        >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Your practice scored <strong className="text-red-500">{score}/100</strong>. Statutory
              penalties for SB 1188 violations can reach <strong>$250,000 per occurrence</strong>.
              Download your full Forensic Report for the complete remediation roadmap.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-7 text-left shadow-lg border-2 border-navy hover:border-gold transition-colors">
              ...
              <p className="text-gray-500 text-sm mb-5 leading-relaxed">
                Complete forensic evidence, technical fixes, and prioritized remediation roadmap for
                your IT team.
              </p>
              <a
                href="https://buy.stripe.com/4gM5kDdpw0HP18x3057Re08"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                Get Full Report — $149
                <span className="block text-xs text-green-400 font-bold mt-0.5">
      ...
      <section className="py-16 bg-white border-t border-gray-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-navy mb-3">
              Almost Sovereign &mdash; Close the Gap
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Your practice scored <strong className="text-amber-500">{score}/100</strong>. A few
              targeted fixes will bring you to full compliance and unlock the Sentry Widget.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-7 text-left shadow-lg border-2 border-navy hover:border-gold transition-colors">
              ...
              <p className="text-gray-500 text-sm mb-5 leading-relaxed">
                Targeted remediation scripts, Safe Harbor checklist, and disclosure templates to
                close your remaining gaps.
              </p>
              <a
                href="https://buy.stripe.com/00w28retAeyF6sRgQV7Re07"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                Get Safe Harbor™ — $249
                <span className="block text-xs text-orange-200 font-bold mt-0.5">
                  + 3 months Shield FREE
                </span>
              </a>
            </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Your practice scored <strong className="text-green-400">{score}/100</strong>. You are
            fully compliant. Deploy the Sentry Widget to broadcast your compliance status in real
            time.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl p-8 text-left shadow-xl relative">
            ...
            <p className="text-gray-600 text-sm mb-2 leading-relaxed">
              Deploy the Widget to activate real-time compliance indicator messaging on your site.
            </p>
            <p className="text-gray-400 text-xs mb-6 italic">
              Less than the cost of a single remediation cycle per year.
            </p>
            <a
            ...
            >
              ...
              <span className="block text-xs text-green-200 font-bold mt-0.5">
                Includes free Audit Report
              </span>
            </a>
          </div>
          <div className="bg-white/5 border-2 border-white/20 rounded-2xl p-8 text-left">
            ...
            <h3 className="text-xl font-display font-bold text-white mb-2">
              15-Minute Strategy Briefing
            </h3>
            <p className="text-gray-300 text-sm mb-3 leading-relaxed">
              Discuss deployment strategy, widget placement, and ongoing compliance monitoring with
              our team.
            </p>
            <div className="bg-white/10 rounded-lg px-3 py-2 mb-6">
              <span className="text-gold text-xs font-bold uppercase tracking-wider">
                Value: $250 &mdash; Waived for NPI Holders
              </span>
            </div>
            <a
              href="https://schedule.fillout.com/t/927Gv1zpdpus"
        ...
        <p className="text-center text-green-400/60 text-sm mt-8 font-medium">
          No further fixes required &bull; Your compliance posture is Sovereign
        </p>
      </div>
    </section>
  );
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-green-200 overflow-hidden">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-8 text-center border-b border-green-100">
                ...
                <div className="flex items-center justify-center gap-2 mt-3 text-sm text-green-600">
                  ...
                  <span>
                    Last verified:{' '}
                    {verifiedData.last_scan_timestamp
        ...
        <section className="py-16 bg-navy text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Join hundreds of Texas healthcare providers displaying their compliance status with
              the KairoLogic Sentry Widget.
            </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/scan">
            <button className="bg-navy text-white font-bold px-6 py-3 rounded-lg">
              Start New Scan
            </button>
          </Link>
        </div>
