        ...
        <div className="m-container">
          <div className="m-footer-grid">
            ...
            <div className="m-footer-col">
              ...
              <ul>
                <li>
                  <Link href="/platform">Provider Monitoring</Link>
                </li>
                <li>
                  <Link href="/platform">Compliance Tracking</Link>
                </li>
                <li>
                  <Link href="/platform">Credentialing Workflows</Link>
                </li>
                <li>
                  <Link href="/platform">Payer Directory Monitoring</Link>
                </li>
              </ul>
            </div>
            <div className="m-footer-col">
              ...
              <ul>
                <li>
                  <Link href="/solutions#practices">Medical Groups &amp; Practices</Link>
                </li>
                <li>
                  <Link href="/solutions#cvos">CVOs &amp; Credentialing Orgs</Link>
                </li>
                <li>
                  <Link href="/solutions#health-systems">Health Systems &amp; Networks</Link>
                </li>
              </ul>
            </div>
            <div className="m-footer-col">
              ...
              <ul>
                <li>
                  <Link href="/compliance">State Compliance Guide</Link>
                </li>
                <li>
          ...
          <div className="m-footer-bottom">
            ...
            <span>
              ...
              &middot; <a href="mailto:info@kairologic.net">info@kairologic.net</a> &middot;{' '}
              <a href="tel:+15124022237">(512) 402-2237</a>
            </span>
          </div>
          <div className="m-compliance-note">
            HIPAA-aligned infrastructure &middot; SOC 2 Type II in progress &middot; Provider data
            sourced from CMS NPPES, state medical boards, and public payer directories
          </div>
        </div>
      </footer>
    </div>
