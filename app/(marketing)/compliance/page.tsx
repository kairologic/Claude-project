        ...
        <div className="m-container" style={{ maxWidth: '780px' }}>
          <div className="m-section-header" style={{ marginBottom: 0 }}>
            ...
            <h1 style={{
              ...
              Regulation tracking,<br /><em style={{ fontStyle: 'italic', color: 'var(--m-gold)' }}>built into every scan</em>
            </h1>
            <p style={{ fontSize: '17px', color: 'var(--m-gray-600)', lineHeight: 1.7, maxWidth: '620px', margin: '0 auto' }}>
              Healthcare regulation varies dramatically by state. KairoLogic maps each state&apos;s
              requirements to provider-level checks so the right compliance rules apply automatically
        ...
        <div className="m-container">
          <div className="m-compliance-states-grid">
            ...
            <div className="m-comp-state-card">
              ...
              <div className="m-comp-regulations">
                <div className="m-comp-reg">
                  ...
                  <p>
                    Requires Protected Health Information to reside on US-based servers.
                    KairoLogic tracks data residency attestation status across your roster
                    and flags providers whose records may be stored in non-compliant locations.
                  </p>
                ...
                <div className="m-comp-reg">
                  ...
                  <p>
                    Mandates disclosure when AI is used in healthcare decision-making.
                    KairoLogic monitors whether your providers&apos; practices have proper
                    AI disclosure policies in place and flags gaps.
                  </p>
                  <div className="m-comp-checks">
              ...
              <div className="m-comp-sources">
                <strong>Data sources:</strong> Texas Medical Board (TMB), NPPES, PECOS, practice website scans
              </div>
            </div>
            ...
            <div className="m-comp-state-card">
              ...
              <p className="m-comp-state-desc">
                California leads in healthcare AI regulation with AB 3030, plus a robust
                FHIR-based provider directory. KairoLogic monitors both.
              </p>
              <div className="m-comp-regulations">
                <div className="m-comp-reg">
                  <div className="m-comp-reg-header">
                  ...
                  <p>
                    Requires healthcare providers to disclose when AI generates communications
                    or is involved in clinical decisions. KairoLogic tracks disclosure policy
                    status across your California providers.
                  </p>
                  <div className="m-comp-checks">
                ...
                <div className="m-comp-reg">
                  ...
                  <p>
                    California offers a FHIR-based provider directory through Blue Shield and
                    other payers. KairoLogic cross-references your provider data against these
                    directories to catch listing discrepancies.
                  </p>
                  <div className="m-comp-checks">
              ...
              <div className="m-comp-sources">
                <strong>Data sources:</strong> Medical Board of California (MBC), Blue Shield CA FHIR API, NPPES, PECOS
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="m-container">
          <div className="m-section-header">
            ...
            <h2 style={{
              ...
              Expanding to <em style={{ fontStyle: 'italic', color: 'var(--m-gold)' }}>all 50 states</em>
            </h2>
            <p>New state profiles activate automatically as we expand — no reconfiguration on your end.</p>
          </div>
        ...
        <div className="m-container" style={{ maxWidth: '780px' }}>
          <div className="m-section-header">
            ...
            <h2 style={{
              ...
              Compliance checks that <em style={{ fontStyle: 'italic', color: 'var(--m-gold)' }}>run themselves</em>
            </h2>
          </div>
          ...
          <div className="m-comp-how-list">
            <div className="m-comp-how-item">
              ...
              <div>
                ...
                <p>Upload a CSV or add providers by NPI. KairoLogic detects which states they practice in and activates the relevant compliance profiles automatically.</p>
              </div>
            </div>
            <div className="m-comp-how-item">
              ...
              <div>
                ...
                <p>Each provider is evaluated against state-specific requirements — data residency, AI disclosure policies, license status, and more. Results appear on your dashboard as compliance scores.</p>
              </div>
            </div>
            <div className="m-comp-how-item">
              ...
              <div>
                ...
                <p>When a new regulation takes effect or a provider&apos;s compliance status changes, KairoLogic surfaces it immediately. No waiting for quarterly audits.</p>
              </div>
            </div>
          </div>
        </div>
