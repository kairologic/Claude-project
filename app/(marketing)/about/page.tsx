    ...
    <>
        ...
        <div className="m-container" style={{ maxWidth: '780px' }}>
          <div className="m-section-header" style={{ marginBottom: 0 }}>
            ...
            <h1 className="m-page-title">
              Making provider data<br />
              <em>actually reliable</em>
            </h1>
            <p className="m-page-subtitle">
              KairoLogic was founded on a simple observation: provider data across the U.S. healthcare system
              is broken, and it&apos;s costing practices millions. We&apos;re building the intelligence layer to fix it.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="m-container">
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '15px', color: 'var(--m-gray-600)', lineHeight: 1.7, marginBottom: '16px' }}>
                Across the healthcare ecosystem, provider directories are riddled with errors. Wrong addresses,
                expired licenses, stale NPI data, mismatched payer records. These inaccuracies create real harm —
                patients can&apos;t find in-network doctors, claims get denied, credentialing stalls, and practices
                lose revenue they never even know about.
              </p>
              <p style={{ fontSize: '15px', color: 'var(--m-gray-600)', lineHeight: 1.7 }}>
                KairoLogic monitors provider data continuously across CMS NPPES, state medical boards, and payer
                directories. When something drifts, we surface it instantly — so your team can fix it before it
                becomes a compliance issue or a lost dollar.
              </p>
            </div>
            <div style={{
      ...
      <section className="m-section" style={{ background: 'var(--m-navy)' }}>
        <div className="m-container">
          <div className="m-section-header" style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.6)', maxWidth: '600px', margin: '0 auto 48px', lineHeight: 1.7 }}>
              One dashboard that connects the dots between NPPES, state boards, payer directories, and your
              internal records — so nothing slips through the cracks.
            </p>
          </div>
          <div style={{
            display: 'grid',
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <h3 style={{ fontSize: '17px', fontWeight: 700, color: 'var(--m-white)', marginBottom: '10px' }}>{card.title}</h3>
                <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.6)', lineHeight: 1.65, margin: 0 }}>{card.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="m-section">
        <div className="m-container" style={{ maxWidth: '780px' }}>
          <div className="m-section-header" style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '15px', color: 'var(--m-gray-600)', lineHeight: 1.7 }}>
              Provider data errors aren&apos;t just an inconvenience — they lead to denied claims, compliance
              penalties, credentialing delays, and patients who can&apos;t find their doctors. We built KairoLogic
              because spreadsheets and manual audits can&apos;t keep up with the scale of modern healthcare operations.
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginTop: '40px' }}>
            {[
              ...
              <div key={i} style={{
                ...
                <h3 style={{ fontSize: '17px', fontWeight: 700, color: 'var(--m-navy)', marginBottom: '8px' }}>{item.title}</h3>
                <p style={{ fontSize: '14px', color: 'var(--m-gray-600)', lineHeight: 1.65, margin: 0 }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="m-section" style={{ background: 'var(--m-gray-50)' }}>
        <div className="m-container" style={{ maxWidth: '680px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '15px', color: 'var(--m-gray-600)', lineHeight: 1.7, marginBottom: '12px' }}>
            KairoLogic is a healthcare technology company headquartered in Austin, TX. We serve medical
            groups, credentialing organizations, and health systems across the United States.
          </p>
