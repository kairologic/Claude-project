...
export default function SupportPage() {
  ...
  return (
    <section className="m-contact-support" style={{ paddingTop: '120px', minHeight: '80vh' }}>
      <div className="m-container">
        <div className="m-contact-support-inner">
          <h2>Get in touch with our team</h2>
          <p className="m-subtitle">
            Our friendly team is here to help. Send us a message and we&apos;ll get back to you
            within 24 hours.
          </p>
          ...
          {supportSubmitted ? (
            ...
            >
              ...
              <p style={{ fontSize: '14px', color: 'var(--m-gray-600)', lineHeight: 1.6 }}>
                ...
                <strong>{supportData.email}</strong> within 24 hours.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSupportSubmit} className="m-contact-form">
              ...
              <button type="submit" className="m-contact-submit" disabled={supportLoading}>
          ...
          >
            ...
            <a href="mailto:info@kairologic.net" style={{ color: 'var(--m-gold)' }}>
              info@kairologic.net
            </a>{' '}
            or call{' '}
            <a href="tel:+15124022237" style={{ color: 'var(--m-gold)' }}>
              (512) 402-2237
            </a>
            .
          </p>
