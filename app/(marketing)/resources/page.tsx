        ...
        <div className="m-container" style={{ maxWidth: '780px' }}>
          <div className="m-section-header">
            ...
            <p className="m-page-subtitle">
              Guides, documentation, and insights to help you get the most from KairoLogic and stay
              ahead of provider data challenges.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="m-container">
          <div className="m-resources-grid">
            ...
            <Link href="/blog" className="m-resource-card">
              ...
              <h2>Insights &amp; Blog</h2>
              <p>
                Analysis of provider data trends, regulatory changes, and credentialing best
                practices. Written for practice administrators and compliance teams.
              </p>
              <span className="m-resource-link">
            ...
            <div className="m-resource-card m-resource-coming">
              ...
              <p>
                Integrate KairoLogic&apos;s provider intelligence into your existing systems. REST
                API with provider lookup, compliance status, and mismatch detection.
              </p>
              <span className="m-resource-link m-muted">Coming soon</span>
            </div>
            ...
            <Link href="/contact" className="m-resource-card">
              ...
              <h2>Contact Us</h2>
              <p>
                Questions about KairoLogic? Reach out to our team. Email info@kairologic.net or call
                (512) 402-2237.
              </p>
              <span className="m-resource-link">
