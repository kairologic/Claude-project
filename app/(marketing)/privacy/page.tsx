      ...
      <section className="m-legal-content">
        <div className="m-container">
          <div className="m-legal-body">
            ...
            <p>
              KairoLogic collects information necessary to provide provider data intelligence and compliance services:
            </p>
            <ul>
            ...
            <p>
              All data is stored on servers physically located within the United States. We implement
              industry-standard security measures including encryption at rest and in transit,
              role-based access controls, and regular security audits. Our infrastructure is
              HIPAA-aligned and we are pursuing SOC 2 Type II certification.
            </p>
            ...
            <ul>
              <li>Service providers who assist in delivering our platform (hosting, payment processing)</li>
