...
export default function PlatformPage() {
  return (
    <>
        ...
        <div className="m-container" style={{ maxWidth: '780px' }}>
          <div className="m-section-header" style={{ marginBottom: 0 }}>
            ...
            <p className="m-page-subtitle">
              One dashboard to monitor your entire provider roster — data integrity, state compliance,
              credentialing progress, and payer directory accuracy. All updated continuously.
            </p>
            <div className="m-hero-actions" style={{ justifyContent: 'center', marginTop: '28px' }}>
              ...
              <Link href="/solutions" className="m-btn-outline">See who it&apos;s for</Link>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="m-platform-feature-list">
                <div className="m-platform-feature-item">
                  ...
                  <div>
                    ...
                    <span>NPI validity, address accuracy, license status, taxonomy matching, and more</span>
                  </div>
                </div>
                <div className="m-platform-feature-item">
                  <span className="m-platform-check">&#10003;</span>
                  <div>
                    ...
                    <span>Get notified the moment something changes — not at the next quarterly review</span>
                  </div>
                </div>
                <div className="m-platform-feature-item">
                  <span className="m-platform-check">&#10003;</span>
                  <div>
                    ...
                    <span>34K+ practice websites scanned to detect roster changes and address discrepancies</span>
                  </div>
                </div>
                <div className="m-platform-feature-item">
                  <span className="m-platform-check">&#10003;</span>
              ...
              <div className="m-platform-mock">
                ...
                <div className="m-platform-mock-body">
                  ...
                  <div className="m-platform-provider-row">
                    <div className="m-platform-prov-dot" style={{ background: 'var(--m-red)' }}></div>
                  ...
                  <div className="m-platform-provider-row">
                    <div className="m-platform-prov-dot" style={{ background: 'var(--m-gold)' }}></div>
                  ...
                  <div className="m-platform-provider-row">
                    <div className="m-platform-prov-dot" style={{ background: 'var(--m-green)' }}></div>
        ...
        <div className="m-container">
          <div className="m-platform-feature m-reverse">
            <div className="m-platform-feature-text">
              ...
              <p>
                State regulations are mapped to provider-level checks automatically. When a new law takes
                effect or your provider&apos;s compliance status changes, your dashboard reflects it immediately.
              </p>
              <div className="m-platform-feature-list">
                <div className="m-platform-feature-item">
                  <span className="m-platform-check">&#10003;</span>
                ...
                <div className="m-platform-feature-item">
                  ...
                  <div>
                    ...
                    <span>Add a provider in a new state and the right compliance checks activate automatically</span>
                  </div>
                </div>
                <div className="m-platform-feature-item">
                  <span className="m-platform-check">&#10003;</span>
          ...
          <div className="m-platform-feature">
              ...
              <div className="m-platform-feature-list">
                ...
                <div className="m-platform-feature-item">
                  ...
                  <div>
                    ...
                    <span>Track enrollment status across UHC, Aetna, Cigna, Humana, BCBS, and more</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="m-platform-feature-visual">
              <div className="m-platform-mock">
                ...
                <div className="m-platform-mock-body">
                  <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--m-navy)', marginBottom: '4px' }}>Dr. Marcus Webb, DO</div>
                  <div style={{ fontSize: '10px', color: 'var(--m-gray-400)', marginBottom: '16px' }}>Family Medicine &middot; Onboarding</div>
                  ...
                  <div className="m-platform-wf-tasks">
                    <div className="m-platform-wf-task"><span className="m-wf-done">&#10003;</span> Assessment complete</div>
                    <div className="m-platform-wf-task"><span className="m-wf-done">&#10003;</span> CAQH profile updated</div>
                    <div className="m-platform-wf-task"><span className="m-wf-active">&#8226;</span> Submit NPPES correction</div>
                    <div className="m-platform-wf-task"><span className="m-wf-pending">&#9675;</span> Payer enrollment (3)</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="m-section" style={{ background: 'var(--m-gray-50)' }} id="payer-directories">
        <div className="m-container">
          <div className="m-platform-feature m-reverse">
            <div className="m-platform-feature-text">
              ...
              <p>
                Your providers are listed in payer directories — but is the data accurate? KairoLogic
                queries each payer&apos;s FHIR directory and flags mismatches against your verified data.
              </p>
              <div className="m-platform-feature-list">
                <div className="m-platform-feature-item">
                  <span className="m-platform-check">&#10003;</span>
                ...
                <div className="m-platform-feature-item">
                  ...
                  <div>
                    ...
                    <span>Auto-generated fix instructions: update CAQH, contact payer relations, or both</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="m-platform-mock">
                ...
                <div className="m-platform-mock-body">
                  <div className="m-platform-payer-grid">
                    <div className="m-platform-payer-cell m-match">UHC<span>Match</span></div>
                    <div className="m-platform-payer-cell m-mismatch">Aetna<span>Mismatch</span></div>
                    <div className="m-platform-payer-cell m-match">Cigna<span>Match</span></div>
                    <div className="m-platform-payer-cell m-not-listed">Humana<span>Not listed</span></div>
                    <div className="m-platform-payer-cell m-match">BCBS<span>Match</span></div>
                  </div>
        ...
        <div className="m-container">
          <div className="m-cta-inner">
            ...
            <div className="m-cta-actions">
              ...
              <Link href="/solutions" className="m-btn-ghost">See who it&apos;s for</Link>
            </div>
          </div>
        </div>
      </div>
