        ...
        <div className="m-container">
          <div className="m-solution-card">
            <div className="m-solution-content">
              ...
              <h2>
                Stop credentialing fires <em>before they start</em>
              </h2>
              <p>
                You run a practice. You shouldn&apos;t also have to manually track whether every
                provider&apos;s NPI is current, their payer listings are accurate, and your
                state&apos;s latest regulations are being met. KairoLogic does that for you.
              </p>
              <div className="m-solution-benefits">
                <div className="m-solution-benefit">
                  ...
                  <div>
                    ...
                    <span>
                      Address mismatches, expired licenses, and taxonomy errors flagged
                      automatically
                    </span>
                  </div>
                </div>
                <div className="m-solution-benefit">
                  ...
                  <div>
                    ...
                    <span>
                      State regulation checks run automatically based on where your providers
                      practice
                    </span>
                  </div>
                </div>
                <div className="m-solution-benefit">
                  ...
                  <div>
                    ...
                    <span>
                      New provider onboarding tracked from assessment through payer enrollment
                    </span>
                  </div>
                </div>
              </div>
              <div className="m-solution-ideal">
                <strong>Ideal for:</strong> Solo practices, group practices, multi-site medical
                groups (1–40 providers)
              </div>
        ...
        <div className="m-container">
          <div className="m-solution-card">
            <div className="m-solution-content">
              ...
              <h2>
                Verify faster, <em>monitor continuously</em>
              </h2>
              <p>
                Credentialing verification is a data problem. You&apos;re comparing
                provider-submitted information against primary sources — NPPES, state boards, payer
                directories — and the data changes constantly. KairoLogic keeps those comparisons
                current.
              </p>
              <div className="m-solution-benefits">
                <div className="m-solution-benefit">
                  ...
                  <div>
                    ...
                    <span>
                      NPPES, state medical boards, PECOS, and payer directories checked on an
                      ongoing basis
                    </span>
                  </div>
                </div>
                <div className="m-solution-benefit">
                  ...
                  <div>
                    ...
                    <span>
                      Every verification, every change, every alert logged with timestamps
                    </span>
                  </div>
                </div>
                <div className="m-solution-benefit">
                  ...
                  <div>
                    ...
                    <span>
                      Monitor enrollment status across all major payers from one dashboard
                    </span>
                  </div>
                </div>
              </div>
              <div className="m-solution-ideal">
                <strong>Ideal for:</strong> Credentialing verification organizations, medical
                staffing companies, delegated credentialing teams
              </div>
              <Link href="/contact" className="m-btn-primary m-gold" style={{ marginTop: '20px' }}>
                Get Started
                <ArrowIcon />
        ...
        <div className="m-container">
          <div className="m-solution-card">
            <div className="m-solution-content">
              ...
              <h2>
                Multi-state, multi-site <em>provider intelligence</em>
              </h2>
              <p>
                Managing provider data across locations, states, and payer contracts means
                complexity multiplies. KairoLogic gives you a single view across your entire network
                with state-specific compliance built in.
              </p>
              <div className="m-solution-benefits">
                <div className="m-solution-benefit">
                  <span className="m-solution-benefit-icon">&#127758;</span>
                  <div>
                    ...
                    <span>
                      TX and CA live today, with 48 more states on the roadmap — all automatic
                    </span>
                  </div>
                </div>
                <div className="m-solution-benefit">
                  ...
                  <div>
                    ...
                    <span>
                      Integrate provider intelligence into your existing systems and workflows
                    </span>
                  </div>
                </div>
                <div className="m-solution-benefit">
                  ...
                  <div>
                    ...
                    <span>
                      No per-provider pricing at enterprise scale — monitor your entire network
                    </span>
                  </div>
                </div>
              </div>
              <div className="m-solution-ideal">
                <strong>Ideal for:</strong> Health systems, physician networks, IPAs, MSOs, payer
                provider relations teams (40+ providers)
              </div>
              <Link href="/contact" className="m-btn-primary m-gold" style={{ marginTop: '20px' }}>
                Contact Sales
                <ArrowIcon />
        ...
        <div className="m-container">
          <div className="m-cta-inner">
            ...
            <div className="m-cta-actions">
              ...
              <Link href="/platform" className="m-btn-ghost">
