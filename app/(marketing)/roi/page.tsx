...
export default function ROICalculatorPage() {
  ...
  const annualDeniedClaimCost =
    mismatchedProviders * DENIED_CLAIMS_PER_MISMATCH * DENIED_CLAIM_COST;
...
function SliderInput({
  ...
  return (
    <div style={{ marginBottom: 28 }}>
      ...
      >
        <label style={{ fontSize: 14, fontWeight: 600, color: '#0F1E2E' }}>{label}</label>
        <span
          style={{
            fontSize: 16,
            fontWeight: 700,
