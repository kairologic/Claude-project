        ...
        <div className="m-hero-split-inner">
          ...
          <div className="m-hero-split-text">
            ...
            <h1>
              Know your providers.
              <br />
              <em>Before problems arise.</em>
            </h1>
            <p className="m-hero-desc">
              KairoLogic continuously monitors 1.8M+ provider records for data integrity, credential
              drift, and state regulation compliance — giving healthcare organizations real-time
            ...
            <div className="m-hero-actions">
              ...
              <Link href="/demo" className="m-btn-outline">
                Watch a Demo
              </Link>
            </div>
            <div className="m-hero-note">
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                <path
                  d="M6.5 1L8 5h4.5L9 7.5l1.5 4L6.5 9 3 11.5l1.5-4L1 5H5.5L6.5 1z"
                  fill="currentColor"
                />
              </svg>
      ...
      <section className="m-section m-scenarios-section">
        <div className="m-container">
          <div className="m-section-header">
            ...
            <h2>
              Provider data breaks in <em>predictable ways</em>
            </h2>
            <p>
              Every scenario below is costing healthcare organizations time, money, and compliance
              standing right now. KairoLogic catches them automatically.
            </p>
          </div>
            ...
            <div className="m-scenario-card">
              <div className="m-scenario-trigger">
                ...
                <div className="m-scenario-trigger-text">
                  ...
                  <div className="m-scenario-what">
                    NPPES still shows the old address. Payer directory lists a third location.
                    Practice website has the correct one.
                  </div>
                </div>
              </div>
            ...
            <div className="m-scenario-card">
              <div className="m-scenario-trigger">
                ...
                <div className="m-scenario-trigger-text">
                  ...
                  <div className="m-scenario-what">
                    Texas SB 1188 now requires data sovereignty attestation. Your 24 providers need
                    compliance checks — today, not next quarter.
                  </div>
                </div>
              </div>
              <div className="m-scenario-divider"></div>
              <div className="m-scenario-response">
                ...
                <p>
                  Maps each state regulation to provider-level checks and surfaces non-compliance
                  the moment a law takes effect. Your dashboard shows exactly which providers are
                  affected and what needs to change.
                </p>
                <div className="m-scenario-checks">
            ...
            <div className="m-scenario-card">
              <div className="m-scenario-trigger">
                ...
                <div className="m-scenario-trigger-text">
                  ...
                  <div className="m-scenario-what">
                    They need CAQH updated, NPPES corrected, and enrollment with 3 payers — each
                    with its own timeline, forms, and follow-ups.
                  </div>
                </div>
              </div>
              <div className="m-scenario-divider"></div>
              <div className="m-scenario-response">
                ...
                <p>
                  Automatically creates a step-by-step workflow: assess the provider&apos;s current
                  data, update CAQH, correct NPPES, submit payer enrollments, and begin continuous
                  monitoring. Every step is tracked and visible.
                </p>
                <div className="m-scenario-checks">
      ...
      <section className="m-section m-pipeline-section">
        <div className="m-container">
          <div className="m-section-header">
            ...
            <h2>
              From new provider to <em>fully enrolled</em>
            </h2>
            <p>
              Most credentialing takes 90–120 days with manual tracking. KairoLogic gives you
              visibility into every step and handles the data work for you.
            </p>
          </div>
            ...
            <div className="m-pipeline-steps">
              <div className="m-pipeline-step m-step-done">
                ...
                <div className="m-pipeline-step-content">
                  <h4>Assess</h4>
                  <p>
                    14-point integrity scan against NPPES, state boards, PECOS, and practice
                    websites
                  </p>
                </div>
              ...
              <div className="m-pipeline-step">
                ...
                <div className="m-pipeline-step-content">
                  <h4>Monitor</h4>
                  <p>
                    Continuous monitoring for data drift, license changes, and directory
                    discrepancies
                  </p>
                </div>
                <div className="m-pipeline-step-owner">
          ...
          <div className="m-coverage-layout">
            <div className="m-coverage-text">
              ...
              <h2>
                One platform.
                <br />
                <em>Every state&apos;s rules.</em>
              </h2>
              <p>
                Healthcare regulation varies by state. KairoLogic maintains state-specific
                compliance profiles so the right checks run automatically based on where each
                provider practices.
              </p>
            ...
            <div className="m-coverage-visual">
              <div className="m-coverage-map">
                <div className="m-map-bg">
                  ...
                  <div className="m-map-label" style={{ left: '26%', top: '68%' }}>
                    Texas
                  </div>
                  <div className="m-map-label" style={{ left: '6%', top: '56%' }}>
                    California
                  </div>
                </div>
              </div>
      ...
      <section className="m-section m-social-section">
        <div className="m-container">
          <div className="m-section-header">
            ...
            <h2>
              What healthcare organizations <em>are saying</em>
            </h2>
          </div>
          <div className="m-testimonial-grid">
            <div className="m-testimonial-card">
              <div className="m-testi-quote">&ldquo;</div>
              <div className="m-testi-text">
                KairoLogic caught an address mismatch for one of our providers that had been quietly
                failing PECOS verification for three months. Fixed in 24 hours instead of the next
                credentialing cycle.
              </div>
            ...
            <div className="m-testimonial-card">
              <div className="m-testi-quote">&ldquo;</div>
              <div className="m-testi-text">
                As a solo practice in Texas, keeping up with SB 1188 and HB 149 felt impossible.
                KairoLogic&apos;s dashboard tells me exactly what to fix and why — no lawyer
                required.
              </div>
              <div className="m-testi-author">
                <div className="m-testi-avatar" style={{ background: 'var(--m-navy-light)' }}>
                  SC
                </div>
                <div>
            ...
            <div className="m-testimonial-card">
              <div className="m-testi-quote">&ldquo;</div>
              <div className="m-testi-text">
                We run credentialing for 200+ providers across TX and CA. KairoLogic&apos;s roster
                monitoring means we see departures and additions within days, not at the next audit.
              </div>
              <div className="m-testi-author">
                <div className="m-testi-avatar" style={{ background: '#4A6FA5' }}>
                  JL
                </div>
                <div>
