      ...
      <section className="m-legal-content">
        <div className="m-container">
          <div className="m-legal-body">
            ...
            <ul>
              <li>
                Provider data monitoring and intelligence across NPPES, state boards, and payer
                directories
              </li>
              <li>
                Compliance tracking for state-level regulations (TX SB 1188, CA AB 3030, and others)
              </li>
            ...
            <p>
              Services are billed as specified at time of purchase. Subscriptions renew
              automatically unless cancelled. All fees are non-refundable unless otherwise stated.
            ...
            <p>
              ...
              . By using our services, you consent to our data collection and use practices as
              described therein.
            </p>
