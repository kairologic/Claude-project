      ...
      <section className="bg-gradient-to-br from-navy via-navy-light to-navy-dark text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-display font-bold mb-6">
            Statutory Risk Briefing
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            15-minute session with our compliance engineering desk to review your forensic findings and migration requirements.
          </p>
          <div className="mt-4 inline-block bg-gold/20 text-gold px-4 py-2 rounded-full text-sm font-semibold">
      ...
      <section className="py-16 bg-navy text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-display font-bold text-center mb-12">
            What&apos;s Covered in Your Briefing
          </h2>
