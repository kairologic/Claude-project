...
import { Shield, Mail, ArrowRight, CheckCircle, AlertTriangle, HelpCircle } from 'lucide-react';
        ...
        {!sent ? (
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-5">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-slate-400 text-xs space-y-1.5 mb-4">
                        <li className="flex items-start gap-2">
                          <span className="text-slate-500 mt-0.5">•</span>
                          You used a different email when you purchased
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-slate-500 mt-0.5">•</span>
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-slate-500 mt-0.5">•</span>
                          There may be a typo in the email address
                        </li>
                      </ul>
                      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-3">
                        <p className="text-slate-300 text-xs font-semibold mb-1">Need help?</p>
                        <p className="text-slate-400 text-xs">
                          Contact us at{' '}
                          <a href="mailto:support@kairologic.net" className="text-gold font-semibold hover:underline">
                            support@kairologic.net
                          </a>
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 text-center">
            ...
            <p className="text-slate-400 text-sm mb-4">
              We sent a login link to <strong className="text-white">{email}</strong>. Click the link to continue.
            </p>
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-lg p-4 text-xs text-slate-500 space-y-1.5">
              <p><strong className="text-slate-400">Step 1:</strong> Click the login link in your email</p>
              <p><strong className="text-slate-400">Step 2:</strong> Enter the 6-digit verification code we&apos;ll send separately</p>
              <p className="text-slate-600 pt-1">🔒 You can choose to trust your device so you won&apos;t need a code next time</p>
            </div>
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-lg p-3 mt-3 text-xs text-slate-500 space-y-1">
