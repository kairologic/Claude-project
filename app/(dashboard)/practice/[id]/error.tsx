  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Something went wrong loading this page. This error has been recorded.
          Try loading again, or navigate back to your practice dashboard.
        </p>
        {error.digest && (
          <p
            style={{
        ...
        >
          <a
            href="https://help.kairologic.com"
            target="_blank"
