      ...
      <section className="relative bg-gradient-to-br from-navy via-navy-light to-navy-dark text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20 pb-16">
          ...
          <h1 className="text-center text-4xl sm:text-5xl md:text-6xl font-display font-extrabold leading-tight mb-6">
            Your Healthcare Website May Be <span className="text-gold">Breaking Texas Law</span>
          </h1>
          ...
          <p className="text-center text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-3 leading-relaxed">
            Texas SB 1188 requires healthcare providers to keep patient data inside the US. Most
            healthcare websites unknowingly send data to servers in Ireland, Singapore, and beyond —
            through Google Fonts, analytics, chatbots, and scheduling tools.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-0 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="relative flex flex-col items-center text-center px-4 py-6">
                ...
                <div
                  className={`w-12 h-12 rounded-xl ${item.color} flex items-center justify-center mb-3 relative z-10`}
                >
                  {item.icon}
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              It&apos;s not about hacking — it&apos;s about where your website sends patient data
              without you knowing.
            </p>
          </div>
            ...
            {[
              {
                ...
                detail:
                  'Google Fonts, analytics, CDNs, and scheduling widgets route patient-identifying data through servers in Ireland, Singapore, and beyond — silently, on every page load.',
                stat: '73%',
              ...
              },
              {
                ...
                detail:
                  'Chatbots, AI scheduling, automated forms — Texas HB 149 requires clear disclosure when AI interacts with patients. Almost no one does this.',
                stat: '89%',
              ...
              },
              {
                ...
                detail:
                  'SB 1188 carries penalties up to $50,000 per violation. A single data breach involving foreign-routed PHI can trigger six-figure liability.',
                stat: '$50K',
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-gray-400">
                  See a real scan → report → dashboard walkthrough
                </div>
              </div>
            </button>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              {
                stat: '481K+',
                label: 'TX providers in registry',
              ...
              <div key={i} className="text-center py-4">
                ...
                <div className="text-2xl md:text-3xl font-display font-black text-navy">
                  {item.stat}
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="border-2 border-gray-200 rounded-2xl p-7 hover:border-gold transition-colors relative">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 text-sm font-semibold text-gold bg-gold/10 hover:bg-gold/20 border border-gold/30 mt-4 px-5 py-2 rounded-full transition-all"
              >
                <FileText size={15} />
            ...
            <div className="border-2 border-orange rounded-2xl p-7 relative shadow-xl shadow-orange/10">
              ...
              <div className="text-xs font-bold uppercase tracking-widest text-orange mb-4">
                One-Time
              </div>
              ...
              <Link href="/scan">
                <button className="w-full btn-primary py-3 text-base">Get Safe Harbor</button>
              </Link>
              <a
                href="/sample-report.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 text-sm font-semibold text-orange bg-orange/10 hover:bg-orange/20 border border-orange/30 mt-4 px-5 py-2 rounded-full transition-all"
              >
                <FileText size={15} />
                Preview sample report
              </a>
          ...
          <div className="mt-12 max-w-3xl mx-auto bg-navy/5 border border-navy/10 rounded-xl p-6 text-center">
            <p className="text-sm text-gray-600">
              <strong className="text-navy">$79/month</strong> vs.{' '}
              <strong className="text-red-600">$50,000+</strong> per compliance violation.{' '}
              <span className="text-gray-500">
                That&apos;s 0.16% of the cost of a single fine — to make sure it never happens.
              </span>
            </p>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: 'Solo and group practices, urgent care, and primary care clinics',
              },
              {
                icon: <Users size={20} />,
                title: 'Dental & Orthodontics',
                desc: 'Dental offices, orthodontic clinics, and oral surgery centers',
              },
              {
                icon: <Shield size={20} />,
                title: 'Mental Health & Wellness',
                desc: 'Therapy practices, counseling centers, and wellness clinics',
              },
              {
                icon: <Eye size={20} />,
                title: 'Med Spas & Specialty',
                desc: 'Med spas, dermatology, chiropractic, optometry, and more',
              },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-6 border border-gray-200 hover:border-gold transition-colors"
              >
      ...
      <section className="py-20 bg-navy">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-xl mx-auto">
            Run a free compliance scan right now. 30 seconds, no signup, no credit card — and
          ...
          <p className="text-xs text-gray-500 mt-4">
            Full report with remediation starts at $149. Every purchase includes 3 months of
            monitoring free.
          </p>
        </div>
      </section>
