...
test.describe('UC-HOME: Dashboard Home', () => {
  ...
  test('UC-HOME-04: Payer sync status panel is visible', async ({ page }) => {
    ...
    const statusText = payerSyncPanel.locator('[data-testid="payer-sync-status-text"]');
    await expect(statusText).toBeVisible();

    // Verify timestamp is displayed
    const timestamp = payerSyncPanel.locator('[data-testid="payer-sync-timestamp"]');
  ...
  test('UC-HOME-06: Practice compliance section is visible', async ({ page }) => {
