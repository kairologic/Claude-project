...
test.describe('Homepage – static content', () => {
  ...
  test('renders key compliance warning text', async ({ page }) => {
    await expect(page.getByText(/fines up to \$50,000 per violation/i)).toBeVisible();
  });
  ...
  test('renders "Three Steps to Compliance" section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /three steps to compliance/i })).toBeVisible();
  });
  ...
  test('renders "Built for Texas Healthcare" section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /built for texas healthcare/i })).toBeVisible();
  });

  test('renders final CTA section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /don.t wait for a regulator/i })).toBeVisible();
  });
...
test.describe('Compliance page – static content', () => {
  ...
  test('renders hero heading', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /sentry compliance standard/i })).toBeVisible();
  });
  ...
  test('renders enforcement timeline', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /enforcement timeline/i })).toBeVisible();
  });

  test('renders compliance scan CTA', async ({ page }) => {
    await expect(page.getByRole('link', { name: /run compliance scan/i })).toBeVisible();
  });
});
...
test.describe('Services page – static content', () => {
  ...
  test('renders main heading', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /your compliance.*handled/i })).toBeVisible();
  });

  test('renders Free Scan tier', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /free compliance scan/i })).toBeVisible();
  });

  test('renders Audit Report tier', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /sovereignty audit report/i })).toBeVisible();
  });

  test('renders Safe Harbor tier', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /safe harbor.*bundle/i })).toBeVisible();
  });

  test('renders Sentry Shield tier', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /sentry shield/i }).first()).toBeVisible();
  });

  test('renders verification matrix', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /verification matrix/i })).toBeVisible();
  });
...
test.describe('Contact page – static content', () => {
  ...
  test('renders page heading', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /contact.*briefing/i })).toBeVisible();
  });
...
test.describe('Scan page – static content', () => {
  ...
  test('renders compliance subtitle', async ({ page }) => {
    await expect(page.getByText(/SB.?1188.*HB.?149.*compliance/i)).toBeVisible();
  });
});
...
test.describe('Registry page – static content', () => {
  ...
  test('renders registry heading', async ({ page }) => {
    await expect(page.getByText(/texas healthcare compliance registry/i)).toBeVisible();
  });

  test('renders search box', async ({ page }) => {
    await expect(page.getByPlaceholder(/search by name.*city.*zip.*npi/i)).toBeVisible();
  });
  ...
  test('renders legal disclaimer', async ({ page }) => {
    await expect(page.getByText(/public-interest disclosure/i)).toBeVisible();
  });
});
...
test.describe('Patients page – static content', () => {
  ...
  test('renders main heading', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /is your provider compliant/i })).toBeVisible();
  });

  test('renders "Your Data, Your Rights" section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /your data, your rights/i })).toBeVisible();
  });
  ...
  test('renders "3 Questions to Ask" section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: /3 questions to ask/i })).toBeVisible();
  });

  test('renders quick check input', async ({ page }) => {
    await expect(page.getByPlaceholder(/hillcountryfamilymed/i)).toBeVisible();
  });
});
